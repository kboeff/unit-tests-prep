...
describe('SoftUniFy', function () {
	...
	it('should have property allSongs', function() {
		expect(obj.hasOwnProperty('allSongs')).to.equal(true, "Class has no property allSongs!")
	});
	
	it('should have property allSongs, which is empty object', function() {
		expect(Object.entries(obj.allSongs).length).to.equal(0, "Property allSongs is not an empty object!")
	});
